...
export interface UsersService {
    FindUserById (data: FindUserByIdRequest) : (FindUserByResponse)
...
export class FindUserByResponse extends createZodDto(z.object({user: CreateUserSchema.merge(z.object({id: z.string().uuid()}))})) {}
