...
import { CheckPasswordRequest, CreateUserRequest, FindUserByEmailRequest, FindUserByIdRequest } from "./users.proto.typs";
export declare class UsersController {
    private readonly usersService;
    constructor(usersService: UsersService);
    findUserById(data: FindUserByIdRequest, metadata: Metadata, call: ServerUnaryCall<any, any>): Promise<{
        user: undefined;
    } | {
