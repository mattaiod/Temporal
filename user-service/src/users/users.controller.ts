...
export class UsersController {
    ...
    async findUserById(data: FindUserByIdRequest, metadata: Metadata, call: ServerUnaryCall<any, any>) : Promise<FindUserByResponse> {
    ...
    findUserByEmail(data: FindUserByEmailRequest , metadata: Metadata, call: ServerUnaryCall<any, any>) {
        console.log("data: ", data);
        return this.usersService.findUserByEmail(data);
    }
    @GrpcMethod('UsersService', 'CheckPassword')
    checkPassword(data: CheckPasswordRequest , metadata: Metadata, call: ServerUnaryCall<any, any>) {
        console.log("data: ", data);
        return this.usersService.checkPassword(data);
    }
    @GrpcMethod('UsersService', 'CreateUser')
    async createUser(data: CreateUserRequest, metadata: Metadata, call: ServerUnaryCall<any, any>) {
        console.log("data: ", data);
